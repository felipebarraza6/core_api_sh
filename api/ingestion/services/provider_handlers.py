...
# Metrics might differ, check if metrics.py moved. If not, use telemetry metrics
from api.telemetry.providers.metrics import TELEMETRY_FETCH_TOTAL, TELEMETRY_FETCH_DURATION
