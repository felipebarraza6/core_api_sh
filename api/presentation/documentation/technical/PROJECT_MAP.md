...
| **API Unificada**           | `unified`          | `unified/`              | Endpoint central clean (V0) para Puntos/Devices.     |
| **Server-Driven UI**        | `dynamic_registry` | `dynamic_registry/`     | Configuración dinámica de módulos y vistas frontend. |
...
| :------------------------------- | :------------ | :------------------------------------------------ |
| `api.core.tasks.dga`             | **REMOVED**   | Cleaned up. Use `compliance_unified`.             |
| `api.core.tasks.sma`             | **REMOVED**   | Cleaned up. Use `compliance_unified`.             |
