...
def write_dga_records_table(worksheet, dga_records: List[TelemetryRecord], 
    ...
    Args:
        worksheet: Worksheet de openpyxl
        dga_records: Lista de registros TelemetryRecord
    ...
    for dga_rec in dga_records:
        ...
        data = [
            ...
            dga_rec.timestamp.strftime('%Y-%m-%d %H:%M:%S') if dga_rec.timestamp else 'Sin registros',
            logger_date,
...
def write_detail_records_table(worksheet, records: List[TelemetryRecord], 
    ...
    Args:
        worksheet: Worksheet de openpyxl
        records: Lista de registros TelemetryRecord
    ...
    for record in records:
        ...
        data = [
            record.timestamp.strftime('%Y-%m-%d %H:%M:%S') if record.timestamp else 'Sin registros',
            logger_date,
