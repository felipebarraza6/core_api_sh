...
class CoreVariableAdmin(admin.ModelAdmin):
    list_display = ('name', 'internal_code', 'point', 'type_definition', 'operation', 'is_active')
    list_filter = ('operation', 'is_active', 'type_definition')
...
class VirtualVariableAdmin(admin.ModelAdmin):
    list_display = ('name', 'internal_code', 'scheme', 'operation', 'is_active')
    list_filter = ('operation', 'is_active', 'scheme')
