#!/usr/bin/env python3
"""
Script para ejecutar la lógica del cronjob twin.py para el punto 161
Recupera el registro de las 23:00 horas con los valores correctos
"""
...
from api.cronjobs.telemetry.controllers.total import (
    total_m3, total_hour, total_day
)
from datetime import datetime
import pytz

def ejecutar_cronjob_punto_161():
    """Ejecuta la lógica del cronjob para el punto 161"""
    ...
    acumulado_dia = total_day(total_calculado, {'id': 161})
