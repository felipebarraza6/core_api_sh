#!/usr/bin/env python3
"""
Recalcular backfill punto 64 (Planta 2 P2) — crisis Redis 19-22 mayo 2026.
Base: 2026-05-19 23:56 UTC, total=11002, pulses=110023, factor=100.
"""
import os, sys, csv
