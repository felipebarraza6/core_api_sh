...
def main():
    ...
    print("\n🎭 SISTEMA ACTUAL (TODOS los cronjobs usan esto)")
    print("-" * 50)
    print("• Importa getters hardcodeados:")
    print("  from .getters.tago import get_data_tago")
    print("  from .getters.tdata import get_data_tdata")
    print("  from .getters.thingsio import get_data_thethings")
    print()
    print("• Lógica condicional por servicio:")
    print("  if service == 'TWIN': get_data_tdata(...)")
    print("  elif service == 'NETTRA': get_data_tago(...)")
    print()
    print("• Funciona pero es inflexible")
